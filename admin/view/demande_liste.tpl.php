...
?>
	<table id="sortable"><thead><tr><th>Date de la demande</th><th>Coordonnées</th><th>Offre de service</th><th>Professionnel</th><?php echo ($flag_traite) ? "<th>Date de traitement</th>" : "";?></tr></thead>
	<tbody>
<?php
