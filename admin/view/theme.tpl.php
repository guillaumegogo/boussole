            ...
            <fieldset style="margin-bottom:1em;">
                ...
                <div class="deux_colonnes" style="width:auto; min-width:auto;">
                    ...
                    <div class="lab">
                        ...
                        <input type="radio" name="actif" value="1" <?php if ($actif_theme_choisi == "1") {
                            echo "checked";
                        } ?>> Oui
                        <input type="radio" name="actif" value="0" <?php if ($actif_theme_choisi == "0") {
                            echo "checked";
                        } ?>> Non
                ...
                <input type="submit" style="display:inline-block; vertical-align:bottom;" name="submit_theme"
                       value="Valider">
            </fieldset>
