...
<div class="button">
	<input type="button" value="Retour" onclick="javascript:location.href='utilisateur<?php if ($vue=="motdepasse") { echo "_detail.php?id=".$id_utilisateur; }else{ echo "_liste.php"; } ?>'">
