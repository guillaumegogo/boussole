...
if ($ENVIRONNEMENT=="LOCAL") {
	echo "<pre>";print_r(@$_POST);echo "<br/>"; echo @$req;echo "<br/>";  print_r(@$row);echo "<br/>";print_r(@$criteres); print_r(@$tab_select_soustheme); echo @$sql."<br/>".@$sqlt."<br/>".@$sqlst."<br/>".@$sqlv."<br/>".@$sqlv2."<br/>".@$req2."</pre>"; 
}
?>
</body>
</html>